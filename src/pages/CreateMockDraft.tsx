                    ...
                    <div className="settings-container">
                        ...
                        <div className="settings-group">
                            ...
                            <PickList setValue={(count) => setTeamCount(count as number)}
                                itemList={[8, 10, 12, 14]} value={10} width={40}
                            />
                        </div>
                        <div className="settings-group">
                            <h5>Pick Time</h5>
                            <PickList setValue={(time) => setPickTime(time as string)}
                                itemList={pickTimes} value={"90 seconds"} width={95}
                                key={pickTimes}
                            />
                        </div>
                    </div>
                        ...
                        <div className="settings-container">
                            <div className="settings-group">
                                ...
                                <PickList setValue={(count) => setPointGuardCount(count as number)}
                                    itemList={[0, 1]} value={pointGuardCount} width={40}
                                    key={pointGuardCount}
                                />
                            </div>
                            <div className="settings-group">
                                ...
                                <PickList setValue={(count) => setShootingGuardCount(count as number)}
                                    itemList={[0, 1]} value={shootingGuardCount} width={40}
                                    key={shootingGuardCount}
                                />
                            </div>
                            <div className="settings-group">
                                <label>G</label>
                                <PickList setValue={(count) => setGuardCount(count as number)}
                                    itemList={[0, 1]} value={guardCount} width={40}
                                    key={guardCount}
                                />
                            </div>
                            <div className="settings-group">
                                ...
                                <PickList setValue={(count) => setSmallforwardCount(count as number)}
                                    itemList={[0, 1]} value={smallforwardCount} width={40}
                                    key={smallforwardCount}
                                />
                            </div>
                            <div className="settings-group">
                                <label>PF</label>
                                <PickList setValue={(count) => setPowerforwardCount(count as number)}
                                    itemList={[0, 1]} value={powerforwardCount} width={40}
                                    key={powerforwardCount}
                                />
                            </div>
                            <div className="settings-group">
                                <label>F</label>
                                <PickList setValue={(count) => setForwardCount(count as number)}
                                    itemList={[0, 1]} value={forwardCount} width={40}
                                    key={forwardCount}
                                />
                            </div>
                            <div className="settings-group">
                            ...
                            <div className="settings-group">
                                ...
                                <PickList setValue={(count) => setUtilityPlayerCount(count as number)}
                                    itemList={[0, 1, 2, 3, 4]} value={utilityPlayerCount} width={40}
                                    key={utilityPlayerCount}
                                />
                            </div>
                            <div className="settings-group">
                                <label>BE</label>
                                <PickList setValue={(benchSize) => setBenchSize(benchSize as number)}
                                    itemList={[0, 1, 2, 3, 4]} value={benchSize} width={40}
                                    key={benchSize}
                                />
                            </div>
                        </div>
...
export default CreateMockDraft;